...
import Adactin.AdactinProject.Adactin_RunnerClass;

public class AdactinTestNgRunnerclass extends Base_Class {
	...
	@Test(priority = 1, groups = "Hotel Booking")
	private void losAngelosHotelBooking() throws Exception {
	...
	private Object[][] data() {
		...
		return new Object[][] {
				...
				{ "29/12/2021", "30/12/2021" }, { "31/12/2021", "02/01/2022" } };

	}

	@Test(groups = "Hotel Booking",dataProvider = "data")
	private void sydneyHotelBooking() throws Exception {
		...
		click(apom.getInstanceSh().getSydney());
